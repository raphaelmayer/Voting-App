		...
		return(
			<div className="container">
				...
				<div className="guide-container">
					<div className="guide-box"><i className="guide-icon fas fa-user-circle"></i><div className="guide-title">1. Log in</div><div className="guide-text">Log in with one click via Facebook. We do not use cookies and do not save your personal data.</div></div>
